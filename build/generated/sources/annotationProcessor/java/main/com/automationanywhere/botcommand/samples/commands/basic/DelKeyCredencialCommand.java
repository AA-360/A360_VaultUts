...
public final class DelKeyCredencialCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DelKeyCredencialCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DelKeyCredencial command = new DelKeyCredencial();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("secret"),(String)convertedParameters.get("path"),(String)convertedParameters.get("key")));
